...
const request_1 = __nccwpck_require__(971);
function webhook(webhookURL, options) {
    return __awaiter(this, void 0, void 0, function* () {
        return (0, request_1.request)("post", webhookURL, {
...
const discord_1 = __nccwpck_require__(945);
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            yield (0, discord_1.webhook)(webhookURL, { title, message, url, color });
        }
        catch (error) {
